...
# Originally by @alrra - https://github.com/alrra/dotfiles/blob/main/src/os/utils.sh
# Modified by @carloscuesta - https://github.com/carloscuesta/dotfiles/blob/master/osx/utils.sh
